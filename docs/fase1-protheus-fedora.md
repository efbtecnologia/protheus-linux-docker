...
**Exemplo de script para o inicializador do AppServer:**
...
**Exemplo de script para o inicializador do DBAccess:**
...
**Exemplo de script para o inicializador do TOTVS License Server**
<app.sh>
